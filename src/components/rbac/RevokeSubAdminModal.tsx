        ...
        <div className="p-4 bg-[#FFE4E6] border border-rose-300/60 rounded-xl flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#211A19] mt-1 leading-relaxed">
              Revoking access for <strong className="text-[#211A19]">{subAdmin.name}</strong> will immediately terminate their sub-admin account, revoke all delegated power section permissions ({subAdmin.powers.join(', ')}), and log them out of the Super Admin Panel.
            </p>
          </div>
        </div>
